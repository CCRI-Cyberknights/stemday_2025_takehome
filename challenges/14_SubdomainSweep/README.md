...
💡 **Hint:** The real agency flag follows this format:  
   `CCRI-AAAA-1111`  
Fake flags use different prefixes or structures.  

👩‍💻 **Tip:** Use the interactive helper script to open and view each subdomain page.  
Alternatively, explore the HTML files directly with `less` or in your browser.  
