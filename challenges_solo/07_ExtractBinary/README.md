...
Analysts believe it contains critical intelligence, but the data is buried deep within the compiled code, surrounded by thousands of lines of "garbage" data.
